...
本Skill通过以下MCP工具与WPS Office交互（共42个已注册工具）：
...
| MCP工具 | 功能描述 | 关键参数 |
|---------|---------|---------|
| `wps_ppt_delete_textbox` | 删除指定文本框 | slideIndex, textboxName |
| `wps_ppt_get_textboxes` | 获取幻灯片上所有文本框列表 | slideIndex |
| `wps_ppt_set_textbox_text` | 设置文本框文本内容 | slideIndex, textboxName, text |
| `wps_ppt_set_textbox_style` | 设置文本框样式 | slideIndex, textboxName, style |
| `wps_ppt_get_slide_title` | 获取幻灯片标题文本 | slideIndex |
| `wps_ppt_set_slide_subtitle` | 设置幻灯片副标题 | slideIndex, subtitle |
| `wps_ppt_set_slide_content` | 设置幻灯片内容区文本 | slideIndex, content |
...
<!-- 审计记录：2026-03-21 T17 同步工具列表 35→42个MCP工具（+文本框操作7个、+presentation管理扩展2个） -->
